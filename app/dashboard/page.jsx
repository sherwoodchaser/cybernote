...
import { Pen, Trash2, FileText, Star, Zap, Icon } from "lucide-react";
import { BorderBeam } from "@/components/ui/border-beam";
import { Empty, EmptyContent } from "@/components/ui/empty";

function Dashboard() {
  const { selectedNote, user, notes } = useCyberNoteData();
                ...
                <div className="flex flex-col items-center justify-center text-center text-muted-foreground space-y-8 mt-10">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4 w-full max-w-3xl">
                    ...
                    <div className="bg-card border border-border/40 rounded-xl p-4 flex flex-col justify-around">
                      ...
                      <p className="text-sm text-muted-foreground line-clamp-2">
                        ...
                        . Keep documenting your research.
                      </p>
                    </div>
                  ...
                  <div className="max-w-md">
                    <p className="text-sm leading-relaxed text-muted-foreground italic">
                      💡 Keep your notes structured — every exploit, every
                      payload, every idea documented here makes you a stronger
                      researcher.
                    </p>
                  </div>
                </div>
